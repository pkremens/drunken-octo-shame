...
/**
 * @author Petr Kremensky pkremens@redhat.com on 14/08/2015
 */
public class InstallerTest {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        ProcessBuilder pb = new ProcessBuilder(buildArgs("java", directConsole, "-jar", INSTALLER.getAbsolutePath(), "-console"));
